...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference("Genre.count") do
      post genres_url, params: { genre: { genrename: @genre.genrename, image: @genre.image } }, as: :json
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { genrename: @genre.genrename, image: @genre.image } }, as: :json
    assert_response :success
  end
